    ...
    $.scrollDepth = function(options) {
      ...
      function sendEvent(action, label, scrollDistance, timing) {
        ...
        var command = options.trackerName ? (options.trackerName + '.send') : 'send';
				...
				// ========= 20180509 added by s.okamoto =========
				var labelValue = '';
        if (label == '#sd-article-bottom') labelValue = 'SD 記事下';
				else if (label == '#sd-bottom-thumbnail') labelValue = 'SD 記事下サムネイル';
				else if (label == '#sd-main-bottom') labelValue = 'SD コンテンツ下';
